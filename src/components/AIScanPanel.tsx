...
export const AIScanPanel = () => {
    ...
    return (
        <div className="w-full flex flex-col relative" style={{ fontFamily: 'var(--font-sans)', height: 'calc(100vh - 200px)' }}>
            {!preview ? (
                ...
                >
                    ...
                    <button onClick={(e) => { e.stopPropagation(); handleFile('/scan_results/647a29da_input.jpg'); }} 
                ...
                <div className="flex-1 flex flex-col lg:flex-row gap-6 p-6 overflow-hidden">
                    <div className="flex-[5] rounded-2xl border border-border bg-surface relative flex items-center justify-center overflow-hidden">
                    ...
                    <div className="flex-[3] rounded-2xl border border-border bg-surface flex flex-col overflow-hidden">
                        ...
                        <div className="p-6 border-t border-border bg-[#0D1117]">
                            ...
                            {!scanning && <button onClick={handleScan} className="w-full py-4 bg-primary text-white font-bold rounded-xl shadow-lg">Start Full Diagnosis</button>}
                        </div>
                    </div>
                </div>
